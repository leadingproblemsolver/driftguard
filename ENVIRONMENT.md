...
AI_API_KEY=YOUR_SERVER_ONLY_OPENAI_KEY
...
Deploy all manifest-declared functions with:

```bash
npm run supabase:functions
```

Deployment uses literal CLI arguments and a pinned Supabase CLI version; no derived slug is passed to Supabase.
